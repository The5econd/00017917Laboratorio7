...
void leerMallayCondiciones(mesh &m,char *filename){
    ...
    float tau, kap, lam, pressFx, pressFy, delta, eta;
    ...
    file >> tau >> kap >> lam >> pressFx >> pressFy >> delta >> eta;
    ...
    m.setParameters((0.25)*tau, kap, (2*lam)/3, pressFx, pressFy, (0.125)*delta, eta);
